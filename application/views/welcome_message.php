...
<div class="ftco-blocks-cover-1">
  <div class="ftco-cover-1 overlay" style="background-image: url('<?=base_url('assets/templates/site')?>/images/banner.jpg')">
    <div class="container">
    ...
    <div class="container">
      <div class="owl-carousel owl-all">
        <div class="service text-center">
          <a href="#"><img src="<?=base_url('assets/templates/site')?>/images/fasilitas/1.png" alt="Image" class="img-fluid"></a>
          <div class="px-md-3">
        ...
        <div class="service text-center">
          <a href="#"><img src="<?=base_url('assets/templates/site')?>/images/fasilitas/2.png" alt="Image" class="img-fluid"></a>
          <div class="px-md-3">
        ...
        <div class="service text-center">
          <a href="#"><img src="<?=base_url('assets/templates/site')?>/images/fasilitas/3.png" alt="Image" class="img-fluid"></a>
          <div class="px-md-3">
    ...
    <div class="owl-carousel nonloop-block-13">
      <div>
        <div class="block-testimony-1 text-center">
          ...
          <figure>
            <img src="<?=base_url('assets/templates/site')?>/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
          </figure>
      ...
      <div>
        <div class="block-testimony-1 text-center">
          ...
          <figure>
            <img src="<?=base_url('assets/templates/site')?>/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
          </figure>
      ...
      <div>
        <div class="block-testimony-1 text-center">
          ...
          <figure>
            <img src="<?=base_url('assets/templates/site')?>/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
          </figure>
